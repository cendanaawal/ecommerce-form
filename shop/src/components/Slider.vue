        ...
        <div class="container">
            ...
            <div class="row">
              <div class="col-lg-6 slider-text">
                ...
                <p>
                  ...
                  Aliquam consequatur illo laborum optio porro quis reiciendis
                  rerum sapiente velit veniam.
                </p>
                <a href="" class="btn-order-now">Order Now</a>
              </div>
              <div class="col-lg-6 slider-image">
                <img
                  src="../assets/assets/images/product/f1.png"
                  class="d-block w-100"
                  alt="..."
                />
              </div>
          ...
          <div class="carousel-item">
            <div class="row">
              ...
              <div class="col-lg-6 slider-image">
                <img
                  src="../assets/assets/images/product/f3.png"
                  class="d-block w-100"
                  alt="..."
                />
              </div>
